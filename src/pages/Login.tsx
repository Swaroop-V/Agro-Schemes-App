...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigation is handled by ProtectedRoute or AuthContext changes
      navigate('/user'); // Default navigation, ProtectedRoute will correct if admin
    } catch (error: any) {
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-200">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center text-sm text-gray-500">
              Admins can log in using their provided credentials.
            </div>
          </div>
        </div>
      </div>
